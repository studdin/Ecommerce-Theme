<?php 
	...
	if(get_theme_mod('header_order_4')){
		...
		$header_order_4 = 'logo-menu-icons';
			...
			<div class="container container-homepage">
				<div class="header-container <?php echo esc_attr($header_order_4); ?>">
					<?php foreach ($arr_header_order as $value) {
						switch ($value) {
							case 'logo': ?>
								<div class="header-logo <?php echo get_theme_mod('logo_pos_4', 'text-left'); ?>">
									<?php keny_header_logo(); ?>
								</div>
							<?php break;
							case 'menu': ?>
								<div class="header-menu <?php echo get_theme_mod('menu_pos_4','menu-center'); ?>">
