<?php 
	...
	if(get_theme_mod('header_order_3')){
		...
		$header_order_3 = 'menu-logo-icons';
...
?>
<header id='bwp-header' class="bwp-header header-v3 header-wrapper-absolute<?php if(get_theme_mod('header_absolute_3',false)) { ?> header-absolute<?php } ?>">
	<?php keny_campbar(); ?>
				...
				<div class="container container-homepage">
					<div class="topbar-container">
						<?php foreach ($arr_topbar_order as $value) { 
							switch ($value) {
							case 'topbar1': ?>
								<?php if(get_theme_mod('content_left_top_bar_3', 'Mid-season sale up to 20% OFF. Use code “KENY24”')) { ?>
									<div class="topbar-left">
										<?php echo get_theme_mod('content_left_top_bar_3', 'Mid-season sale up to 20% OFF. Use code “KENY24”'); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'topbar2': ?>
								<?php if(get_theme_mod('content_center_top_bar_3', 'content topbar 2')) { ?>
									<div class="topbar-center">
										<?php echo get_theme_mod('content_center_top_bar_3', 'content topbar 2'); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'topbar3': ?>
								<?php if(get_theme_mod('content_right_top_bar_3', '<div class="email"><a href="mailto:keny@example.com">keny@example.com</a></div><div class="order"><a href="#">Order tracking</a></div>')) { ?>
									<div class="topbar-right">
										<?php echo get_theme_mod('content_right_top_bar_3', '<div class="email"><a href="mailto:keny@example.com">keny@example.com</a></div><div class="order"><a href="#">Order tracking</a></div>'); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'social': ?>
							...
							<?php break;
							case 'shortcode': ?>
								<?php if(get_theme_mod('shortcode_3', '')) { ?>
									<div class="shortcode_topbar">
										<?php echo do_shortcode (get_theme_mod('shortcode_3','')); ?>
									</div>
								<?php } ?>
							<?php break; default: ?>
							<?php } ?>
	...
	<div class="header-desktop">
		<div class='header-wrapper' data-sticky_header="<?php echo esc_attr($keny_settings['enable-sticky-header']); ?>">
			<div class="container container-homepage">
				<div class="header-container <?php echo esc_attr($header_order_3); ?>">
					<?php foreach ($arr_header_order as $value) {
						switch ($value) {
							case 'menu': ?>
								<div class="header-menu <?php echo get_theme_mod('menu_pos_3','menu-left'); ?>">
							...
							<?php break;
							case 'logo': ?>
								<div class="header-logo <?php echo get_theme_mod('logo_pos_3', 'text-center'); ?>">
