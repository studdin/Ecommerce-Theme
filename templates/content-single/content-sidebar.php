...
<div class="content-single-sidebar">
	<div class="container">
		...
		<div class="single-post-content row">
			...
			<?php endif; ?>
			<div class="post-single <?php echo esc_attr($post_single_layout); ?> <?php echo esc_attr(keny_get_class()->class_single_content); ?>">
					...
					<div class="post-content-entry">
						...
						<?php if ( shortcode_exists( 'social_share' ) ) : ?> 
							<div class="entry-social-share">
								<label><?php echo esc_html__('Share :','keny'); ?></label>
