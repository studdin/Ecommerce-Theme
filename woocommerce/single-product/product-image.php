...
if(keny_image_single_product()->product_layout_thumb == "one_column")
	wc_get_template( 'single-product/content-image/one_column.php' );
elseif(keny_image_single_product()->product_layout_thumb == "two_column")
	wc_get_template( 'single-product/content-image/two_column.php' );
elseif(keny_image_single_product()->product_layout_thumb == "slider")
	wc_get_template( 'single-product/content-image/slider.php' );
elseif(keny_image_single_product()->product_layout_thumb == "moderm")
	wc_get_template( 'single-product/content-image/moderm.php' );
elseif(keny_image_single_product()->product_layout_thumb == "full_width")
	wc_get_template( 'single-product/content-image/full_width.php' );
elseif(keny_image_single_product()->product_layout_thumb == "clean")
	wc_get_template( 'single-product/content-image/clean.php' );
elseif(keny_image_single_product()->product_layout_thumb == "grid")
	wc_get_template( 'single-product/content-image/grid.php' );
elseif(keny_image_single_product()->product_layout_thumb == "grid_sticky")
	wc_get_template( 'single-product/content-image/grid_sticky.php' );
elseif(keny_image_single_product()->product_layout_thumb == "lagre_gallery")
