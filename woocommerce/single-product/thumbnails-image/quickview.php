...
remove_action( 'woocommerce_single_product_summary', 'keny_add_thumb_single_product', 40 );
remove_action( 'woocommerce_after_single_product', 'keny_sticky_cart', 50 );
remove_action( 'woocommerce_single_product_summary', 'keny_get_countdown', 20 );
remove_action( 'woocommerce_single_product_summary', 'keny_add_social', 45 );
remove_action( 'woocommerce_single_product_summary', 'keny_add_loop_wishlist_link', 35 );
