...
<div class="woocommerce-cart-header" data-count="<?php echo esc_attr($woocommerce->cart->cart_contents_count); ?>">
	<div class="cart-details">
		<div class="remove-cart">
			<div class="top-total-cart"><?php echo esc_html__("Shopping Cart","keny"); ?>(<?php echo esc_attr($woocommerce->cart->cart_contents_count); ?>)</div>
			<a class="cart-remove" href="#" title="<?php esc_attr_e("View your shopping cart", "keny"); ?>">
		...
		<form class="cart-header-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
								...
								<div class="product-remove">
									...
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											...
											esc_attr( sprintf( __( 'Remove %s from cart', 'keny' ), $_product->get_name() ) ),
											esc_attr( $product_id ),
											esc_attr( $cart_item_key ),
											esc_attr( $_product->get_sku() ),
											esc_html__( "Remove", "keny" )
										),
										$cart_item_key
									);
									?>
				...
				<?php else : ?>
					<div class="empty">
						<span><?php echo esc_html__( 'Your cart is currently empty.', 'keny' ); ?></span>
						<a class="go-shop" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php echo esc_html__( 'Shop all products', 'keny' ); ?></a>
					</div>
				<?php endif; ?>
			</div>
			...
			<div class="ajaxcart__footer">
				<?php if ( ! WC()->cart->is_empty() ) : ?>
					...
					<div class="total-cart">
						<div class="title-total"><?php echo esc_html__( 'Subtotal: ', 'keny' ); ?></div>
				...
				<?php if ( ! WC()->cart->is_empty() ) : ?>
					<div class="buttons">
						<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button btn view-cart btn-primary"><span><?php echo esc_html__( 'View Cart', 'keny' ); ?></span></a>
						<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button btn checkout btn-default"><span><?php echo esc_html__( 'Check Out', 'keny' ); ?></span></a>
					</div>
				<?php endif; ?>
