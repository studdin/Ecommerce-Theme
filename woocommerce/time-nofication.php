...
$time_nofication = keny_get_config('time-nofication',false);
$start_time	= keny_get_config('time-nofication-start',5);
$stay_time	= keny_get_config('time-nofication-stay',5);
$products	= keny_get_config('time-nofication-products','');
$users	= keny_get_config('time-nofication-user','');
$ranges	= keny_get_config('time-nofication-range','');
?>
		...
		<div class="notification-container">
			...
			<div class="notification-content">
				<div class="notification-purchased">
					<span class="name"></span> <?php echo esc_html__("purchased","keny"); ?>
				</div>
				<div class="product-title"><a href="#"></a></div>
				<div class="suggest">
					<div class="time-suggest"></div>
					<div class="verified"><?php echo esc_html__("verified","keny"); ?></div>
				</div>
			</div>
		</div>
