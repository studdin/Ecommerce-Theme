<?php ///////////////HEADER 1
				...
				<div class="bwp-drop-control">
					...
					<div class="bwp-drag-dropdown_content">
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="shortcode">
							...
							<textarea type="text" data-setting="shortcode_1" placeholder="[gallery id=&quot;121&quot; size=&quot;medium&quot;]" value="<?php echo esc_attr($this->value('shortcode_1')); ?>" <?php $this->link('shortcode_1'); ?>></textarea>
							<div class="btn-delete-drop-content"><button class="delete-drop-content"><?php echo esc_html__('Delete','keny'); ?></button></div>
						</div>
	...
	$wp_customize->add_control(new Padding_header_1(
		...
		array(
			'label' => esc_html__('Padding header bottom','keny'),
			'section' => 'bwp-header_1',
			'settings' => [
