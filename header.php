...
/**
 * Version:            1.0.0
 * Theme Name:         keny * Theme URI:          http://wpbingosite.com/themes/keny/
 * Author:             Wpbingo
...
<?php
	$header_style  = keny_config_header()->header_style;
	$enable_sticky_header = keny_config_header()->enable_sticky_header;
	$show_minicart = keny_config_header()->show_minicart;
	$show_searchform = keny_config_header()->show_searchform;
	$background_page = keny_config_header()->background_page;
	$checkout_page_style = keny_config_header()->checkout_page_style;
?>
<!--<![endif]-->
<head>
							...
							<?php if($show_minicart || $show_searchform){ ?>
								...
								<div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 margin-top-20">
									...
									<div class="search-box pull-right">
										...
										<div class="dropdown-search"><?php keny_search_form_product(); ?></div>
									</div>
									<?php } ?>
									<!-- End Search -->
								</div>
